...
var typed = new Typed(".typing", {
  strings: ["Iam a front end developer", "Ui Ux design"],
  typeSpeed: 70,
  loop: true,
});
// =============Typed Js selesai============== //
...
//   const playMusik = document.querySelector("#play");

//   audio.play().catch((error) => {
//     console.log("audio dibatasi", error);
//   });
//   playMusik.addEventListener("click", () => {
//     audio.play();
//   });
// });
